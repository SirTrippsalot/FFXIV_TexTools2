...
//experimental loader to allow app to save in a different space <-- App.xaml < properties < Build Action = Page (required change)
...
namespace FFXIV_TexTools2
{
    ...
    public partial class App : Application
    {
        ...
        //this needs to have the debug code added
